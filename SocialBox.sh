...
echo -e "	[+]              $red Coded By SmartSoft$nc                          [+]"
echo -e "	[+] 		 $red www.facebook.com/OfficialSmartSoft$nc          [+]"
echo -e "	[+] 		 $red Greetz To All SmartSoft Members$nc             [+]"
echo -e "	[+]     $red Special Greetz To$nc :$green {Smarty Singh from SmartSoft}$nc    [+]"
echo ""
